...
async function recenterPosition(connection, dlmmPool, userKeypair, oldPositionPubKey, originalParams = {}, rebalanceDirection = null) {
  ...
  return {
    ...
    // 📊 CRITICAL: New baseline value for dynamic P&L tracking
    newDepositValue: openRes.initialCapitalUsd, // The actual USD value of capital deployed in new position
  };
}
